...
void Mesh::Init(const std::vector<Vertex>& vertices,
  ...
  m_vertexBuffer =
      Buffer::CreateWithData(GL_ARRAY_BUFFER, GL_STATIC_DRAW, vertices.data(),
                             sizeof(Vertex), vertices.size());

  m_indexBuffer =
      Buffer::CreateWithData(GL_ELEMENT_ARRAY_BUFFER, GL_STATIC_DRAW,
                             indices.data(), sizeof(uint32_t), indices.size());

  m_vertexLayout->SetAttrib(0, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex), 0);
  m_vertexLayout->SetAttrib(1, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex),
                            offsetof(Vertex, normal));
  m_vertexLayout->SetAttrib(2, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex),
